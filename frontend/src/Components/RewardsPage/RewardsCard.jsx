    ...
    const handleRedemption = async () => {
        try {
            ...
            const response = await axios.post(
                `http://${config.baseURL}/rewards/rewards/claim/${rewardID}?user_id=${userId}`
            );
        ...
        const fetchImage = async () => {
            try {
                const response = await axios.get(
                    `http://${config.baseURL}/rewards/rewards/${rewardID}/image`,
                    {
                        responseType: "blob",
                    }
                );
