...
const ProfilePage = () => {
        ...
        const fetchUserData = async () => {
            try {
                const response = await axios.get(
                    `http://${config.baseURL}/users/users/?user_id=${userId}`
                );
    ...
    useEffect(() => {
        ...
        const fetchImage = async () => {
            try {
                const response = await axios.get(
                    `http://${config.baseURL}/users/users/profilePicture/${userId}`,
                    {
                        responseType: "blob",
                    }
                );
    ...
    const handleUpdate = async () => {
        ...
        try {
            ...
            const response = await axios.put(
                `http://${config.baseURL}/users/users/${user.userID}/update/`,
                updatedUser
            );
    ...
    const handlePasswordReset = async () => {
        try {
            ...
            const response = await axios.post(
                `http://${config.baseURL}/public/public/password-reset-request`,
                {
