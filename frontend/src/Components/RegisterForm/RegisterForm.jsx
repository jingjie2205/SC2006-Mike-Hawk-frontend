    ...
    >
      ...
      >
        ...
        <div className="messages">
          {emptyError && (
            <MessageBox type="error">Please fill all fields</MessageBox>
          )}
          {passwordError && (
            <MessageBox type="error">Passwords do not match</MessageBox>
          )}
          {duplicateEntryError && (
            <MessageBox type="error">Username/Email used</MessageBox>
          )}
          {invalidEmail && (
          ...
          {submitted && (
            <MessageBox type="success">Successfully Registered</MessageBox>
          )}
        </div>
